...
<div class="container">
    <div class="post">
        ...
        <p>我<span style="color: crimson">${requestScope.ID}</span>作为一枚<span style="color: crimson">${requestScope.1}</span>级的资深屌丝，哪有什么机会学习篆刻。
        ...
        <p>现在我依靠极速手指头，已经在${requestScope.5}抢到一张${requestScope.2}元的粮票了，
            然后不知不觉中，合计抢到了${requestScope.3}张${requestScope.4}元的粮票了。
